...
\begin{table}[ht]% not h om its own
...
%"We generate the gender wage gap at the regional level as the diﬀerence between men’s and women’s wages divided by men’s wages."
...
\begin{table}[btp] %Main Results
    \caption{Fixed effects regressions of wage gaps at 10th percentile, 25th percentile and mean (in labour market regions).}
    \centering
    \resizebox{\textwidth}{!}{%
